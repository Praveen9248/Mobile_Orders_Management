...
<head>
    ...
    <link rel="shortcut icon" href="logo_images/logo.jpeg" type="image/x-icon">
...
<header>
        <div class="header_main">
            ...
            <div class="cart">
                <a href="cart.php"><img src="logo_images/cart.jpeg" alt="Cart" width="50px"></a>
            </div>
        ...
        <div class="header_navbar">
            <div class="nav">
                <a href="products_user.php?category=Mobiles">Mobiles</a>
                <a href="products_user.php?category=Accessories">Accessories</a>
                <a href="products_user.php?category=Audio store">Audio store</a>
                <a href="products_user.php?category=Laptops">Laptops</a>
                <a href="products_user.php?category=Tablets">Tablets</a>
            </div>
        </div>
        <div id="results"></div>
    </header>
        ...
        <div class="main_content">
            ...
            <div class="mobile_section">
                ...
                <div class="mobile_section_slider">
                    ...
                    <?php endforeach; ?>
                    <div class="slide_mobiles">
                        <button style="padding-right: 25px; margin-top: 115px; margin-right: 30px;"><a href="products_user.php?category=Mobiles">View more</a></button>
                    </div>
                </div>
            </div>
            ...
            <div class="laptop_section">
                ...
                <div class="laptop_section_slider">
                    ...
                    <?php endforeach; ?>
                    <div class="slide_laptop">
                        <button style="padding-right: 25px; margin-top: 115px; margin-right: 30px;"><a href="products_user.php?category=Laptops">View more</a></button>
                    </div>
                </div>
            </div>
            ...
            <div class="accessories_section">
                ...
                <div class="accessories_section_slider">
                    ...
                    <?php endforeach; ?>
                    <div class="slide_accessories">
                        <button style="padding-right: 25px; margin-top: 115px; margin-right: 30px;"><a href="products_user.php?category=Accessories">View more</a></button>
                    </div>
                </div>
            </div>
